...
Quarto documents accept Markdown syntax to format the prose. It provides the basic of word processing documents, like different levels of headers, bold font, italics, underlined. Importantly and usefully, it also provides a way to format code within the prose.

### Activity

Take a look at the two cheatsheets that RStudio has about Markdown syntax (Help \> Cheat Sheets \> R Markdown Cheat Sheet & R Markdown Reference Guide) or websites about Mardown, for example, [markdownguide.org](https://www.markdownguide.org/basic-syntax/).
