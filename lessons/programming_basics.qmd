...
-   `character`
    ...
    -   E.g., `"hello world"` and `c("hello", "hola", "hej")`
        ...
        -   You can extract part of a string with the `str_sub()` function (doc [here](https://stringr.tidyverse.org/reference/str_sub.html)).
...
-   Students create a string with a single word, and then use `if else` (either a code block of a function) to print to the user whether the word begins with a vowel or a consonant.
    ...
    -   Hint 2: The [`str_sub()`](https://stringr.tidyverse.org/reference/str_sub.html) function can be used to extract a sub part of a string.
