...
Exploration time: Take a look at the docs for the themes by entering `?theme_bw` at the console, and then try from the other themes. Be ready to report which theme you like the most, and which you like the least.
