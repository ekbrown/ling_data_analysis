...
Let's take a look at a dataset used to write [an article](https://doi.org/10.1515/cllt-2020-0016) about the effect of fast speech on word durations and the durations of the /s/ segment in a sample of Colombian Spanish. It's named "Dataset_fast_spch_Colombia.xlsx" in the LMS.
