...
Your task is to create a new column that groups the vowels into one level, the consonants into their own group, and then other following segments should be placed into an `other` level.
