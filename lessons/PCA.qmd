...
The eigenvalues indicate how much of the variance is explained by each principal component. (BTW, there are as many principal components as there are variables that go into the PCA.) Let's look at the eigenvalues and the percentage of variance explained by each PC:
